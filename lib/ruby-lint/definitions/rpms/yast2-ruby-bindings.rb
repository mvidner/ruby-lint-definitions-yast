...
RubyLint.registry.register('Yast') do |defs|
  defs.define_constant('Yast') do |klass|
    ...
    klass.define_method('add_include_path') do |method|
      method.define_argument('arg1')
    end

    klass.define_method('add_module_path') do |method|
      method.define_argument('arg1')
    end

    klass.define_method('call_yast_function') do |method|
      method.define_rest_argument('arg1')
    end

    klass.define_method('deep_copy') do |method|
      method.define_argument('object')
      method.define_optional_argument('options')
    end

    klass.define_method('find_include_file') do |method|
      method.define_argument('arg1')
    end

    klass.define_method('import') do |method|
      method.define_argument('mname')
    end

    klass.define_method('import_pure') do |method|
      method.define_argument('arg1')
    end
    ...
    klass.define_method('strcoll') do |method|
      method.define_argument('arg1')
      method.define_argument('arg2')
    end

    klass.define_method('symbols') do |method|
      method.define_argument('arg1')
    end

    klass.define_method('ui_component')

    klass.define_method('ui_component=') do |method|
      method.define_argument('arg1')
    end

    klass.define_method('ui_finalizer')

    klass.define_method('y2_logger') do |method|
      method.define_rest_argument('arg1')
    end

    klass.define_method('y2_logger_helper') do |method|
    ...
    klass.define_instance_method('arg_ref') do |method|
      method.define_rest_argument('args')
    end

    klass.define_instance_method('copy_arg') do |method|
      method.define_argument('object')
    end

    klass.define_instance_method('deep_copy') do |method|
      method.define_argument('object')
    end

    klass.define_instance_method('fun_ref') do |method|
      method.define_rest_argument('args')
    end
    ...
    klass.define_instance_method('term') do |method|
      method.define_rest_argument('args')
    end

    klass.define_instance_method('y2_logger') do |method|
      method.define_rest_argument('arg1')
    end
  end

  defs.define_constant('Yast::ArgRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Break') do |klass|
  ...
  defs.define_constant('Yast::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Builtins::DEF_LENGHT') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Builtins::Float') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_method('abs') do |method|
      method.define_argument('value')
    end
    ...
    klass.define_method('pow') do |method|
      method.define_argument('base')
      method.define_argument('power')
    end

    klass.define_method('tolstring') do |method|
      method.define_argument('arg1')
      method.define_argument('arg2')
    end

    klass.define_method('trunc') do |method|
      method.define_argument('value')
    end
  end

  defs.define_constant('Yast::Builtins::List') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    ...
    klass.define_method('swap') do |method|
      method.define_argument('list')
      method.define_argument('offset1')
      method.define_argument('offset2')
    end
  end

  defs.define_constant('Yast::Builtins::Multiset') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_method('difference') do |method|
      method.define_argument('set1')
      method.define_argument('set2')
    end
    ...
    klass.define_method('symmetric_difference') do |method|
      method.define_argument('set1')
      method.define_argument('set2')
    end
  ...
  defs.define_constant('Yast::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::ArgRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Client::Break') do |klass|
    klass.inherits(defs.constant_proxy('StandardError', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::Client::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Client::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Client::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::Client::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Client::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Exportable::ExceptionReporter') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('last_exception')
  end

  defs.define_constant('Yast::Exportable::ExportData') do |klass|
    klass.inherits(defs.constant_proxy('OpenStruct', RubyLint.registry))

    klass.define_instance_method('private?')
  end

  defs.define_constant('Yast::Exportable::ExportData::InspectKey') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::I18n::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::I18n::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Exportable::ExceptionReporter', RubyLint.registry))
  ...
  defs.define_constant('Yast::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Ops::GenericComparable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Comparable', RubyLint.registry))
  ...
  defs.define_constant('Yast::Ops::GenericComparable::CLASS_ORDER') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Ops::HashComparator') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Comparable', RubyLint.registry))
  ...
  defs.define_constant('Yast::Ops::ListComparator') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Comparable', RubyLint.registry))
  ...
  defs.define_constant('Yast::Ops::OUTER_LOOP_FRAME') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Ops::SHORTCUT_TYPES') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Ops::TYPES_MAP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Comparable', RubyLint.registry))
  ...
  defs.define_constant('Yast::Path::COMPLEX_CHAR_REGEX') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::Path::SIMPLE_CHAR_REGEX') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Enumerable', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Comparable', RubyLint.registry))
  ...
  defs.define_constant('Yast::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::UIShortcuts::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::Y2Logger') do |klass|
    klass.inherits(defs.constant_proxy('Logger', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Singleton', RubyLint.registry))
  ...
  defs.define_constant('Yast::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
