...
RubyLint.registry.register('Yast::SequencerClass') do |defs|
  defs.define_constant('Yast::SequencerClass') do |klass|
    ...
    klass.define_instance_method('Run') do |method|
      ...
      method.define_argument('sequence')
    end

    klass.define_instance_method('WS_alias') do |method|
      method.define_argument('aliases')
      method.define_argument('alias_')
    end

    klass.define_instance_method('WS_check') do |method|
      method.define_argument('aliases')
      method.define_argument('sequence')
    end

    klass.define_instance_method('WS_error') do |method|
      method.define_argument('error')
    end

    klass.define_instance_method('WS_next') do |method|
      method.define_argument('sequence')
      method.define_argument('current')
      method.define_argument('ret')
    end

    klass.define_instance_method('WS_pop') do |method|
      method.define_argument('stack')
    end

    klass.define_instance_method('WS_push') do |method|
      method.define_argument('stack')
      method.define_argument('item')
    end

    klass.define_instance_method('WS_run') do |method|
      method.define_argument('aliases')
      method.define_argument('id')
    end

    klass.define_instance_method('WS_special') do |method|
      method.define_argument('aliases')
      method.define_argument('alias_')
    end

    klass.define_instance_method('WS_testall') do |method|
      method.define_argument('aliases')
    end
  ...
  defs.define_constant('Yast::SequencerClass::ArgRef') do |klass|
  ...
  defs.define_constant('Yast::SequencerClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::SequencerClass::Break') do |klass|
  ...
  defs.define_constant('Yast::SequencerClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::SequencerClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::SequencerClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::SequencerClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Sequencer') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::SequencerClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::SequencerClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::SequencerClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::SequencerClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
