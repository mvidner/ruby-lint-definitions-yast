...
RubyLint.registry.register('Yast::InternetClass') do |defs|
  defs.define_constant('Yast::InternetClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('Connected')

    klass.define_instance_method('GetDevices')

    klass.define_instance_method('Reset')

    klass.define_instance_method('SetDemand') do |method|
      method.define_argument('demand')
    end

    klass.define_instance_method('ShutdownAllLocalDHCPClients')
    ...
    klass.define_instance_method('askpassword')

    klass.define_instance_method('askpassword=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('capi_adsl')

    klass.define_instance_method('capi_adsl=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('capi_isdn')

    klass.define_instance_method('capi_isdn=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('demand')

    klass.define_instance_method('demand=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('device')

    klass.define_instance_method('device=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('do_test')

    klass.define_instance_method('do_test=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('do_you')

    klass.define_instance_method('do_you=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('logfile')

    klass.define_instance_method('logfile=') do |method|
      method.define_argument('arg1')
    end
    ...
    klass.define_instance_method('suse_register')

    klass.define_instance_method('suse_register=') do |method|
      method.define_argument('arg1')
    end
  ...
  defs.define_constant('Yast::InternetClass::Address') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::AddressClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Arch') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::ArchClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::ArgRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::Break') do |klass|
  ...
  defs.define_constant('Yast::InternetClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::InternetClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::CommandLine') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::CommandLineClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Desktop') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::DesktopClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Directory') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::DirectoryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::DontShowAgain') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::DontShowAgainClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::FileUtils') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::FileUtilsClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Hostname') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::HostnameClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::IP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::IPClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Icon') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::IconClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Integer') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::IntegerClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Internet') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::Kernel') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::KernelClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::Label') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::LabelClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Linuxrc') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::LinuxrcClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Map') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::MapClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Message') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::MessageClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Misc') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::MiscClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Mode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::ModeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Netmask') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::NetmaskClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::NetworkConfig') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::NetworkConfigClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    ...
    klass.define_instance_method('DHCP')

    klass.define_instance_method('DHCP=') do |method|
      method.define_argument('arg1')
    end
    ...
    klass.define_instance_method('ReadConfig') do |method|
      method.define_argument('config')
    end

    klass.define_instance_method('Write')

    klass.define_instance_method('WriteConfig') do |method|
      method.define_argument('config')
  ...
  defs.define_constant('Yast::InternetClass::NetworkService') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::NetworkServiceClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))

    klass.define_instance_method('ConfirmNetworkManager')

    klass.define_instance_method('EnableDisableNow')

    klass.define_instance_method('IsActive')

    klass.define_instance_method('Modified')

    klass.define_instance_method('Read')

    klass.define_instance_method('ReloadOrRestart')

    klass.define_instance_method('Restart')

    klass.define_instance_method('RunSystemCtl') do |method|
      method.define_argument('service')
      method.define_argument('action')
    end

    klass.define_instance_method('RunningNetworkPopup')

    klass.define_instance_method('StartStop')

    klass.define_instance_method('backend_available?') do |method|
      method.define_argument('backend')
    end

    klass.define_instance_method('disable')

    klass.define_instance_method('disabled?')

    klass.define_instance_method('isNetworkRunning')

    klass.define_instance_method('isNetworkv4Running')

    klass.define_instance_method('isNetworkv6Running')

    klass.define_instance_method('is_backend_available') do |method|
      method.define_argument('backend')
    end

    klass.define_instance_method('is_disabled')

    klass.define_instance_method('is_netconfig')

    klass.define_instance_method('is_network_manager')

    klass.define_instance_method('is_wicked')

    klass.define_instance_method('main')

    klass.define_instance_method('netconfig?')

    klass.define_instance_method('network_manager?')

    klass.define_instance_method('run_wicked') do |method|
      method.define_rest_argument('params')
    end

    klass.define_instance_method('use_netconfig')

    klass.define_instance_method('use_network_manager')

    klass.define_instance_method('use_wicked')

    klass.define_instance_method('wicked?')
  end

  defs.define_constant('Yast::InternetClass::OSRelease') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::OSReleaseClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::OSReleaseFileMissingError') do |klass|
    klass.inherits(defs.constant_proxy('StandardError', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::PackageCallbacks') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::PackageCallbacksClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::PackageKit') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::PackageKitClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::PackageLock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::PackageLockClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::PackageSystem') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::PackageSystemClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::PackagesCommonInclude') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::PackagesProposal') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::PackagesProposalClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Pkg') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Popup') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::PopupClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Progress') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::ProgressClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Report') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::ReportClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Service') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::ServiceClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::SignatureCheckCallbacks') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::SignatureCheckCallbacksClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::SignatureCheckDialogs') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::SignatureCheckDialogsClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Stage') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::StageClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::String') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::StringClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Summary') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::SummaryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Systemctl') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::SystemctlError') do |klass|
    klass.inherits(defs.constant_proxy('StandardError', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::SystemdService') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::SystemdServiceClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::SystemdServiceNotFound') do |klass|
    klass.inherits(defs.constant_proxy('StandardError', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::SystemdUnit') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::TypeRepository') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::TypeRepositoryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::UI') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::URL') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::URLClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::URLRecode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::URLRecodeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Wizard') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::WizardClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::XML') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InternetClass::XMLClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::InternetClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InternetClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
