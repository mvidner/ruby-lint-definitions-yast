...
RubyLint.registry.register('Yast::LogViewClass') do |defs|
  defs.define_constant('Yast::LogViewClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('AdvancedHelp') do |method|
      method.define_argument('label')
    end

    klass.define_instance_method('AdvancedSaveHelp') do |method|
      method.define_argument('label')
    end

    klass.define_instance_method('CreateHelp') do |method|
      method.define_argument('logs')
      method.define_argument('parameters')
    end

    klass.define_instance_method('CreateWidget') do |method|
      method.define_argument('parameters')
      method.define_argument('log_files')
    end
    ...
    klass.define_instance_method('DisplayFiltered') do |method|
      method.define_argument('file')
      method.define_argument('grep')
    end

    klass.define_instance_method('DisplaySimple') do |method|
      method.define_argument('file')
    end

    klass.define_instance_method('GetButtonsBelowLog') do |method|
      method.define_argument('popup')
      method.define_argument('glob_param')
      method.define_argument('_log_maps')
    end

    klass.define_instance_method('GetDefaultItemForLogsCombo') do |method|
      method.define_argument('log_maps')
    end

    klass.define_instance_method('GetLogSelectionCombo') do |method|
      method.define_argument('log_maps')
    end

    klass.define_instance_method('GetMenuButtonWidget') do |method|
      method.define_argument('actions')
      method.define_argument('save')
      method.define_argument('mb_label')
    end

    klass.define_instance_method('Index2Descr') do |method|
      method.define_argument('index')
    end

    klass.define_instance_method('InitLogReading') do |method|
      method.define_argument('index')
    end

    klass.define_instance_method('KillBackgroundProcess') do |method|
      method.define_argument('_key')
    end

    klass.define_instance_method('LogHandle') do |method|
      method.define_argument('_key')
      method.define_argument('event')
    end

    klass.define_instance_method('LogInit') do |method|
      method.define_argument('_key')
    end

    klass.define_instance_method('LogSelectionHelp')

    klass.define_instance_method('LogSwitch') do |method|
      method.define_argument('index')
    end

    klass.define_instance_method('SaveHelp')

    klass.define_instance_method('SingleLogHelp')

    klass.define_instance_method('main')
  end

  defs.define_constant('Yast::LogViewClass::ArgRef') do |klass|
  ...
  defs.define_constant('Yast::LogViewClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::Break') do |klass|
  ...
  defs.define_constant('Yast::LogViewClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::LogViewClass::CWM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::CWMClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Desktop') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::DesktopClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Directory') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::DirectoryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::FileUtils') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::FileUtilsClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::Label') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::LabelClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::LogView') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::LogViewCore') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::LogViewCoreClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('DeleteOldLines')

    klass.define_instance_method('GetLines')

    klass.define_instance_method('GetNewLines')
  ...
  defs.define_constant('Yast::LogViewClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Map') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::MapClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Misc') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::MiscClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Mode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::ModeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::OSRelease') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::OSReleaseClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::OSReleaseFileMissingError') do |klass|
    klass.inherits(defs.constant_proxy('StandardError', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Popup') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::PopupClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Report') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::ReportClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Stage') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::StageClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::String') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::StringClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Summary') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::SummaryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::UI') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Wizard') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::LogViewClass::WizardClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::LogViewClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::LogViewClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
