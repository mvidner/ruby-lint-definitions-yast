...
RubyLint.registry.register('Yast::XVersionClass') do |defs|
  defs.define_constant('Yast::XVersionClass') do |klass|
    ...
    klass.define_instance_method('binPath')

    klass.define_instance_method('fontPath')

    klass.define_instance_method('includePath')

    klass.define_instance_method('infoPath')

    klass.define_instance_method('lib64Path')

    klass.define_instance_method('libPath')

    klass.define_instance_method('main')

    klass.define_instance_method('manPath')

    klass.define_instance_method('sharePath')
  end

  defs.define_constant('Yast::XVersionClass::ArgRef') do |klass|
  ...
  defs.define_constant('Yast::XVersionClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::XVersionClass::Break') do |klass|
  ...
  defs.define_constant('Yast::XVersionClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::XVersionClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::XVersionClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::XVersionClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::XVersionClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::XVersion') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::XVersionClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::XVersionClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::XVersionClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
