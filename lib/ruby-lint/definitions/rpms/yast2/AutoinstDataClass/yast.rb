...
RubyLint.registry.register('Yast::AutoinstDataClass') do |defs|
  defs.define_constant('Yast::AutoinstDataClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('BootCylWarning')

    klass.define_instance_method('BootCylWarning=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('BootLVMWarning')

    klass.define_instance_method('BootLVMWarning=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('BootRaidWarning')

    klass.define_instance_method('BootRaidWarning=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('main')

    klass.define_instance_method('mouse')

    klass.define_instance_method('mouse=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('post_packages')

    klass.define_instance_method('post_packages=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('post_patterns')

    klass.define_instance_method('post_patterns=') do |method|
      method.define_argument('arg1')
    end
  end

  defs.define_constant('Yast::AutoinstDataClass::ArgRef') do |klass|
  ...
  defs.define_constant('Yast::AutoinstDataClass::AutoinstData') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AutoinstDataClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AutoinstDataClass::Break') do |klass|
  ...
  defs.define_constant('Yast::AutoinstDataClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::AutoinstDataClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AutoinstDataClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AutoinstDataClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AutoinstDataClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::AutoinstDataClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AutoinstDataClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
