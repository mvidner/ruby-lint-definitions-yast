...
RubyLint.registry.register('Yast::GPGWidgetsClass') do |defs|
  defs.define_constant('Yast::GPGWidgetsClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('AskPassphrasePopup') do |method|
      method.define_argument('key')
    end

    klass.define_instance_method('AskPassphraseTerm')

    klass.define_instance_method('AskPassphraseWidget') do |method|
      method.define_argument('key')
    end

    klass.define_instance_method('CreateNewKey')

    klass.define_instance_method('GPGItems') do |method|
      method.define_argument('private_keys')
    end

    klass.define_instance_method('GpgInitPrivate') do |method|
      method.define_argument('key')
    end

    klass.define_instance_method('GpgInitPublic') do |method|
      method.define_argument('key')
    end

    klass.define_instance_method('GpgNewKey') do |method|
      method.define_argument('key')
      method.define_argument('event')
    end

    klass.define_instance_method('GpgStorePrivate') do |method|
      method.define_argument('key')
      method.define_argument('event')
    end

    klass.define_instance_method('GpgStorePublic') do |method|
      method.define_argument('key')
      method.define_argument('event')
    end

    klass.define_instance_method('Passphrase')

    klass.define_instance_method('PassphraseStore') do |method|
      method.define_argument('key')
      method.define_argument('event')
    end

    klass.define_instance_method('PrivateKeySelection')

    klass.define_instance_method('PublicKeySelection')

    klass.define_instance_method('SelectedPrivateKey')

    klass.define_instance_method('SetSelectedPrivateKey') do |method|
      method.define_argument('keyid')
    end

    klass.define_instance_method('SetSelectedPublicKey') do |method|
      method.define_argument('keyid')
    end
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Address') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::AddressClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::ArgRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::Break') do |klass|
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::GPGWidgetsClass::CWM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::CWMClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::CommandLine') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::CommandLineClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Desktop') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::DesktopClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Directory') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::DirectoryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::FileUtils') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::FileUtilsClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::GPG') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::GPGClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('CreateKey')

    klass.define_instance_method('ExportAsciiPublicKey') do |method|
      method.define_argument('keyid')
      method.define_argument('file')
    end

    klass.define_instance_method('ExportPublicKey') do |method|
      method.define_argument('keyid')
      method.define_argument('file')
    end

    klass.define_instance_method('Init') do |method|
      method.define_argument('home_dir')
      method.define_argument('force')
    end

    klass.define_instance_method('PrivateKeys')

    klass.define_instance_method('PublicKeys')

    klass.define_instance_method('SignAsciiDetached') do |method|
      method.define_argument('keyid')
      method.define_argument('file')
      method.define_argument('passphrase')
    end

    klass.define_instance_method('SignDetached') do |method|
      method.define_argument('keyid')
      method.define_argument('file')
      method.define_argument('passphrase')
    end

    klass.define_instance_method('SignFile') do |method|
      method.define_argument('keyid')
      method.define_argument('file')
      method.define_argument('passphrase')
      method.define_argument('ascii_signature')
    end

    klass.define_instance_method('VerifyFile') do |method|
      method.define_argument('sig_file')
      method.define_argument('file')
    end

    klass.define_instance_method('buildGPGcommand') do |method|
      method.define_argument('options')
    end

    klass.define_instance_method('callGPG') do |method|
      method.define_argument('options')
    end

    klass.define_instance_method('main')

    klass.define_instance_method('parseKeys') do |method|
      method.define_argument('input')
    end

    klass.define_instance_method('parse_key') do |method|
      method.define_argument('lines')
    end
  end

  defs.define_constant('Yast::GPGWidgetsClass::GPGWidgets') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::Hostname') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::HostnameClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::IP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::IPClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Integer') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::IntegerClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::Label') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::LabelClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Map') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::MapClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Misc') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::MiscClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Mode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::ModeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Netmask') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::NetmaskClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::OSRelease') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::OSReleaseClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::OSReleaseFileMissingError') do |klass|
    klass.inherits(defs.constant_proxy('StandardError', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Popup') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::PopupClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::ReportClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Stage') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::StageClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::String') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::StringClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Summary') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::SummaryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::TypeRepository') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::TypeRepositoryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::UI') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::URL') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::URLClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::URLRecode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::URLRecodeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Wizard') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::WizardClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::XML') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::GPGWidgetsClass::XMLClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::GPGWidgetsClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::GPGWidgetsClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
