...
RubyLint.registry.register('Yast::CommandLineClass') do |defs|
  defs.define_constant('Yast::CommandLineClass') do |klass|
  ...
  defs.define_constant('Yast::CommandLineClass::Address') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::AddressClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::ArgRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::Break') do |klass|
  ...
  defs.define_constant('Yast::CommandLineClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::CommandLineClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::CommandLine') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Directory') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::DirectoryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::FileUtils') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::FileUtilsClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Hostname') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::HostnameClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::IP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::IPClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Integer') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::IntegerClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::Label') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::LabelClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Mode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::ModeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Netmask') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::NetmaskClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Popup') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::PopupClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Report') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::ReportClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Stage') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::StageClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::String') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::StringClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Summary') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::SummaryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::TypeRepository') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::TypeRepositoryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::UI') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::URL') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::URLClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::URLRecode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::URLRecodeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::XML') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::CommandLineClass::XMLClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::CommandLineClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::CommandLineClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
