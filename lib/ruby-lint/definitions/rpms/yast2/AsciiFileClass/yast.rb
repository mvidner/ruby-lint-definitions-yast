...
RubyLint.registry.register('Yast::AsciiFileClass') do |defs|
  defs.define_constant('Yast::AsciiFileClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('AppendLine') do |method|
      method.define_argument('file')
      method.define_argument('entry')
    end

    klass.define_instance_method('AssertLineValid') do |method|
      method.define_argument('file')
      method.define_argument('line')
    end

    klass.define_instance_method('ChangeLineField') do |method|
      method.define_argument('file')
      method.define_argument('line')
    ...
    klass.define_instance_method('FindLineField') do |method|
      method.define_argument('file')
      method.define_argument('field')
    ...
    klass.define_instance_method('NumLines') do |method|
      method.define_argument('file')
    end

    klass.define_instance_method('ReadFile') do |method|
      method.define_argument('file')
      method.define_argument('pathname')
    end

    klass.define_instance_method('RemoveLines') do |method|
      method.define_argument('file')
      method.define_argument('lines')
    end

    klass.define_instance_method('ReplaceLine') do |method|
      method.define_argument('file')
      method.define_argument('line')
      method.define_argument('entry')
    end

    klass.define_instance_method('RewriteFile') do |method|
      method.define_argument('file')
      method.define_argument('fpath')
    end

    klass.define_instance_method('SetComment') do |method|
      method.define_argument('file')
      method.define_argument('comment')
    end

    klass.define_instance_method('SetDelimiter') do |method|
      method.define_argument('file')
      method.define_argument('delim')
    end

    klass.define_instance_method('SetListWidth') do |method|
      method.define_argument('file')
      method.define_argument('widths')
    end

    klass.define_instance_method('main')
  end

  defs.define_constant('Yast::AsciiFileClass::ArgRef') do |klass|
  ...
  defs.define_constant('Yast::AsciiFileClass::AsciiFile') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AsciiFileClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AsciiFileClass::Break') do |klass|
  ...
  defs.define_constant('Yast::AsciiFileClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::AsciiFileClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AsciiFileClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AsciiFileClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::AsciiFileClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::AsciiFileClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::AsciiFileClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
