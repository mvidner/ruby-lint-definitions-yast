...
RubyLint.registry.register('Yast::MailAliasesClass') do |defs|
  defs.define_constant('Yast::MailAliasesClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('FilterRootAlias')

    klass.define_instance_method('GetRootAlias')

    klass.define_instance_method('MergeRootAlias') do |method|
      method.define_argument('aliases')
    end

    klass.define_instance_method('ReadAliases')

    klass.define_instance_method('SetRootAlias') do |method|
      method.define_argument('destinations')
    end

    klass.define_instance_method('WriteAliases')

    klass.define_instance_method('aliases')

    klass.define_instance_method('aliases=') do |method|
      method.define_argument('arg1')
    end

    klass.define_instance_method('main')

    klass.define_instance_method('mergeTables') do |method|
      method.define_argument('new')
      method.define_argument('old')
    end

    klass.define_instance_method('root_alias')

    klass.define_instance_method('root_alias=') do |method|
      method.define_argument('arg1')
    end
  end

  defs.define_constant('Yast::MailAliasesClass::ArgRef') do |klass|
  ...
  defs.define_constant('Yast::MailAliasesClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::MailAliasesClass::Break') do |klass|
  ...
  defs.define_constant('Yast::MailAliasesClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::MailAliasesClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::MailAliasesClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::MailAliasesClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::MailAliases') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::MailAliasesClass::MailTable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    ...
    klass.define_method('Flush') do |method|
      method.define_rest_argument('args')
    end
    ...
    klass.define_method('SetFileName') do |method|
      method.define_rest_argument('args')
    end
  ...
  defs.define_constant('Yast::MailAliasesClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::MailAliasesClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::MailAliasesClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::MailAliasesClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
