...
RubyLint.registry.register('Yast::InstExtensionImageClass') do |defs|
  defs.define_constant('Yast::InstExtensionImageClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('CutLastDirOrFile') do |method|
      method.define_argument('url')
    end

    klass.define_instance_method('DesintegrateExtension') do |method|
      method.define_argument('_extension')
    end

    klass.define_instance_method('DisintegrateAllExtensions')

    klass.define_instance_method('DownloadAndIntegrateExtension') do |method|
      method.define_argument('extension')
    end

    klass.define_instance_method('IsURLRelative') do |method|
      method.define_argument('url')
    end

    klass.define_instance_method('LazyInit')

    klass.define_instance_method('LoadExtension') do |method|
      method.define_argument('package')
      method.define_argument('message')
    end

    klass.define_instance_method('MergeURLs') do |method|
      method.define_argument('url_base')
      method.define_argument('url_with_modifs')
    end

    klass.define_instance_method('MergeURLsParams') do |method|
      method.define_argument('base_url')
      method.define_argument('url_with_modifs')
    end

    klass.define_instance_method('UnLoadExtension') do |method|
      method.define_argument('package')
      method.define_argument('message')
    end
    ...
    klass.define_instance_method('with_extension') do |method|
      method.define_argument('package')
      method.define_block_argument('block')
    end
  end

  defs.define_constant('Yast::InstExtensionImageClass::ArgRef') do |klass|
  ...
  defs.define_constant('Yast::InstExtensionImageClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::Break') do |klass|
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::InstExtensionImageClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Directory') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::DirectoryClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::FileUtils') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::FileUtilsClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Hostname') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::HostnameClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::IP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::IPClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::InstExtensionImage') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::Label') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::LabelClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Linuxrc') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::LinuxrcClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Mode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::ModeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Netmask') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::NetmaskClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Popup') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::PopupClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Stage') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::StageClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::String') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::StringClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::Logger', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::UI') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::URL') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::URLClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::URLRecode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::InstExtensionImageClass::URLRecodeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::InstExtensionImageClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::InstExtensionImageClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
