...
RubyLint.registry.register('Yast::PunycodeClass') do |defs|
  defs.define_constant('Yast::PunycodeClass') do |klass|
    klass.inherits(defs.constant_proxy('Yast::Module', RubyLint.registry))

    klass.define_instance_method('ConvertBackAndForth') do |method|
      method.define_argument('strings_in')
      method.define_argument('to_punycode')
    end

    klass.define_instance_method('CreateNewCacheRecord') do |method|
      method.define_argument('decoded')
      method.define_argument('encoded')
    end

    klass.define_instance_method('DecodeDomainName') do |method|
      method.define_argument('encoded_domain_name')
    end

    klass.define_instance_method('DecodePunycodes') do |method|
      method.define_argument('punycode_strings')
    end

    klass.define_instance_method('DocodeDomainNames') do |method|
      method.define_argument('encoded_domain_names')
    end

    klass.define_instance_method('EncodeDomainName') do |method|
      method.define_argument('decoded_domain_name')
    end

    klass.define_instance_method('EncodePunycodes') do |method|
      method.define_argument('punycode_strings')
    end

    klass.define_instance_method('GetDecodedCachedString') do |method|
      method.define_argument('encoded_string')
    end

    klass.define_instance_method('GetEncodedCachedString') do |method|
      method.define_argument('decoded_string')
    end

    klass.define_instance_method('GetMaximumCacheSize')

    klass.define_instance_method('GetTmpDirectory')

    klass.define_instance_method('SetMaximumCacheSize') do |method|
      method.define_argument('new_max_size')
    end

    klass.define_instance_method('main')
  end

  defs.define_constant('Yast::PunycodeClass::ArgRef') do |klass|
  ...
  defs.define_constant('Yast::PunycodeClass::BACKTRACE_REGEXP') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::PunycodeClass::Break') do |klass|
  ...
  defs.define_constant('Yast::PunycodeClass::Builtins') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Byteblock') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

    klass.define_instance_method('to_s')
  end

  defs.define_constant('Yast::PunycodeClass::Client') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Convert') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::DEFAULT_LOCALE') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::PunycodeClass::Debugger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Exportable') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::External') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::FunRef') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::I18n') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::LOCALE_DIR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::PunycodeClass::Logger') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Module') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast::UIShortcuts', RubyLint.registry))
    klass.inherits(defs.constant_proxy('Yast', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Ops') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Path') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Profiler') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Punycode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::PunycodeClass::SCR') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Term') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::UIShortcuts') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::UI_TERMS') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))

  end

  defs.define_constant('Yast::PunycodeClass::WFM') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::Y2Logger') do |klass|
  ...
  defs.define_constant('Yast::PunycodeClass::YCode') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
  ...
  defs.define_constant('Yast::PunycodeClass::YReference') do |klass|
    klass.inherits(defs.constant_proxy('Object', RubyLint.registry))
